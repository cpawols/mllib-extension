...
class TestCsvReaderTest(TestCase):
    def test_read_csv_file(self):
        matrix = CSVReader.read_csv("/home/krzysztof/mgr/mllib-extension/data/csv_test_file.csv")
    ...
    def test_read_csv_float_value(self):
        matrix = CSVReader.read_csv("/home/krzysztof/mgr/mllib-extension/data/csv_test_float_numbers.csv")
