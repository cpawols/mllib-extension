...
na 48 komputerach o następujących parametrach:
  ...
  \end{itemize}
Do eksperymentów wykorzystałem zbiór danych WAVEFORM zawierający informacje % TODO: dodać info o datasecie.%
...
\begin{figure}
 ...
 \includegraphics[scale=1.0, keepaspectratio=true]{./wykresy/disc_scores.png}
\end{figure}
...
\begin{figure}
 \caption{Czas wykonania metody w sekundach}
 \includegraphics[scale=1.0]{./wykresy/disc_time_identity.png}
\end{figure}

\begin{figure}
 \caption{Metryka speed-up}
 \includegraphics[scale=1.0]{./wykresy/disc_time_speed_up.png}
\end{figure}

\begin{figure}
 \caption{Metryka scale-up}
 \includegraphics[scale=1.0]{./wykresy/disc_time_scale_up.png}
\end{figure}
...
\begin{figure}
 \caption{Score w zależności od rozmiaru populacji}
 \centering\includegraphics[scale=0.7]{./wykresy/fe_score_pop.png}
\end{figure}

\begin{figure}
 \caption{Score w zależnosci od maksymalnej liczby iteracji}
 \centering\includegraphics[scale=0.7]{./wykresy/fe_score_mi.png}
\end{figure}

\begin{figure}
 \caption{Score w zależności od rozmiaru genomu}
 \centering\includegraphics[scale=0.7]{./wykresy/fe_score_b.png}
\end{figure}

\begin{figure}
 \caption{Czas w zależności od rozmiaru populacji}
 \centering\includegraphics[scale=0.7]{./wykresy/fe_time_pop.png}
\end{figure}

\begin{figure}
 \caption{Czas w zależności od maksymalnej liczby iteracji}
 \centering\includegraphics[scale=0.7]{./wykresy/fe_time_mi.png}
\end{figure}

\begin{figure}
 \caption{Czas w zależności od rozmiaru genomu}
 \centering\includegraphics[scale=0.7]{./wykresy/fe_time_b.png}
\end{figure}
...
%TODO: wycentrować obrazki
  
\begin{figure}
 \caption{Score w zależności od rozmiaru populacji}
 \centering\includegraphics[scale=0.7]{./wykresy/tree_score_pop.png}
\end{figure}

\begin{figure}
 \caption{Score w zależnosci od maksymalnej liczby iteracji}
 \centering\includegraphics[scale=0.7]{./wykresy/tree_score_mi.png}
\end{figure}

\begin{figure}
 \caption{Score w zależności od warunku stopu}
 \centering\includegraphics[scale=0.7]{./wykresy/tree_score_mdr.png}
\end{figure}

\begin{figure}
 \caption{Czas w zależności od rozmiaru populacji}
 \centering\includegraphics[scale=0.7]{./wykresy/tree_time_pop.png}
\end{figure}

\begin{figure}
 \caption{Czas w zależności od maksymalnej liczby iteracji}
 \centering\includegraphics[scale=0.7]{./wykresy/tree_time_mi.png}
\end{figure}

\begin{figure}
 \caption{Czas w zależności od warunku stopu}
 \centering\includegraphics[scale=0.7]{./wykresy/tree_time_mdr.png}
\end{figure}
Widzimy, że zarówno wyniki jak i czas pogarszają się gdy zwiększymy parametr warunku stopu.
...
Oto porównanie najlepszych wyników jakie uzyskałem dla zbioru WAVEFORM:
% TODO: dodac SVM
...
\begin{center}
 \begin{tabular}{l || P{2.5cm} | P{2.5cm} | P{2.5cm} | P{2.5cm}}
  ...
  \hline
  Score (accuracy) & 0.7376     & ??      & 0.758          & 0.790 \\
  Czas (s) & 0.12     & ??      & 6.04    & 191.00 \\
 \end{tabular}
\end{center}
